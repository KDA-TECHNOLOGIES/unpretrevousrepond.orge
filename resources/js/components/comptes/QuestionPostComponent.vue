<template>
    <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
        ...
        <div class="card-body d-flex p-0 mt-0">
            ...
            <a href="#" class=" font-xssss fw-600 text-grey-700 card-body p-0 d-flex align-items-center"><i class="btn-round-sm font-xs text-primary feather-edit-3 me-2 bg-greylight"></i>Publier</a>
