...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('comptes/images/favicon.png')}}">
    <!-- Custom Stylesheet -->
    <link rel="stylesheet" href="{{asset('comptes/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('comptes/css/emoji.css')}}">

    <link rel="stylesheet" href="{{asset('comptes/css/lightbox.css')}}">
...
<script src="{{asset('comptes/js/lightbox.js')}}"></script>
